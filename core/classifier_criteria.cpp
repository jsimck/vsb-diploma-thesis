...
std::ostream &operator<<(std::ostream &os, const ClassifierCriteria &crit) {
    ...
    os << "  |_ smallestTemplate: " << crit.info.smallestTemplate.width  << "x" <<  crit.info.smallestTemplate.height << std::endl;
    os << "  |_ largestTemplate: " << crit.info.largestTemplate.width  << "x" <<  crit.info.largestTemplate.height << std::endl;
